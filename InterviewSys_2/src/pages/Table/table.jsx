...
const apiURL = "http://10.20.23.32:6970/senior/get_assigned_score/66b07deb090b1d517582ee3e";
        ...
        <tbody>
          {data.juniors.map((junior, index) => (
            <tr className="hover" key={junior.junior_id}>
              ...
              <td>{junior.scores[index]?.score || '0'}</td> {/* Displaying first score */}
              <td>{junior.scores[index+1]?.score || '0'}</td> {/* Handle additional scores */}
